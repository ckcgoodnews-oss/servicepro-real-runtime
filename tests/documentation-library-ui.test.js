...
assert.match(renderer, /function headingSlug/);
assert.match(renderer, /aardvark-enterprises\\\.net\\\/docs/);
assert.match(renderer, /document\.getElementById\(targetId\)\?\.scrollIntoView/);
assert.match(renderer, /<h2 id={id}/);
assert.match(renderer, /repository-heading-anchor/);
