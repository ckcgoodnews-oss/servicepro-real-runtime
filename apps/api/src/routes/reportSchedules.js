...
const tenant=req=>req.context.tenantId;const repo=req=>req.context.repositories.reportSchedules;const fail=(res,error)=>sendJson(res,error.status||500,{error:{code:error.code||'error',message:error.message,details:error.details||{}}});
