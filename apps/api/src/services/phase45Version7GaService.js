...
const DOMAINS = ["version-7-rc-telemetry", "version-7-regression-triage", "api-v7-compatibility", "database-v7-upgrade-certification", "tenant-v7-migration-dry-runs", "version-7-load-certification", "version-7-dependency-remediation", "version-7-accessibility-certification", "version-7-disaster-recovery-certification", "version-7-administrator-documentation", "version-7-customer-pilot", "version-7-defect-closure", "version-7-production-readiness", "version-7-ga-orchestration", "version-7-general-availability"];
