...
const DOMAINS = ["enterprise-organization-federation", "cross-tenant-collaboration", "federated-identity-expansion", "partner-data-exchange", "ecosystem-trust-registry", "enterprise-delegated-administration", "shared-service-operations", "intercompany-workflow-orchestration", "federated-audit-exchange", "partner-compliance-attestations", "external-data-contracts", "ecosystem-event-bus", "marketplace-revenue-federation", "federation-security-certification", "version-3-4-general-availability"];
