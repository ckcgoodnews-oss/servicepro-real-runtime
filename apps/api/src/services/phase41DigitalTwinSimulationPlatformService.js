...
const DOMAINS = ["asset-digital-twins", "facility-digital-twins", "telemetry-synchronization", "simulation-model-registry", "what-if-analysis", "failure-simulation", "capacity-simulation", "maintenance-simulation", "energy-simulation", "twin-version-management", "twin-security-controls", "simulation-experiment-management", "simulation-results-analytics", "digital-twin-governance", "digital-twin-release-readiness"];
