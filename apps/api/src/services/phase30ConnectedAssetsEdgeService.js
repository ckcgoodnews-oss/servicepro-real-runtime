...
const DOMAINS = ["edge-device-registry", "telemetry-ingestion", "device-twin-management", "edge-rule-engine", "offline-command-queue", "firmware-campaigns", "sensor-health-monitoring", "edge-security-posture", "site-gateway-management", "industrial-protocol-adapters", "edge-data-retention", "remote-diagnostics", "edge-fleet-analytics", "edge-failover-certification", "connected-assets-release"];
