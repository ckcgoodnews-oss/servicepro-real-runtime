...
const DOMAINS = ["carbon-accounting", "energy-consumption-tracking", "fleet-emissions-management", "supplier-sustainability-scoring", "waste-stream-tracking", "circular-asset-lifecycle", "repair-versus-replace-optimization", "recycled-materials-inventory", "environmental-compliance-reporting", "water-usage-monitoring", "sustainability-target-management", "green-service-routing", "customer-sustainability-reporting", "sustainability-analytics", "enterprise-sustainability-operations"];
