...
const DOMAINS = ["spatial-asset-maps", "robot-fleet-registry", "robot-mission-planning", "robot-safety-zones", "robot-telemetry-ingestion", "robot-maintenance-planning", "digital-twin-synchronization", "computer-vision-inspections", "autonomous-route-optimization", "edge-robotics-command", "robot-operator-handoff", "robot-incident-management", "robot-compliance-evidence", "robot-fleet-analytics", "spatial-robotics-command-center"];
