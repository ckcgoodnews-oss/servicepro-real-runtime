...
const DOMAINS = ["unified-customer-journey", "mobile-offline-workspace", "technician-route-intelligence", "real-time-customer-tracking", "digital-service-check-in", "mobile-forms-and-signatures", "customer-preference-center", "proactive-appointment-communications", "field-collaboration", "mobile-inventory-operations", "customer-self-service-automation", "experience-quality-analytics", "accessibility-for-field-applications", "mobile-security-hardening", "version-3-2-general-availability"];
