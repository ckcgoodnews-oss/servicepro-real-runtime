...
const DOMAINS = ["production-telemetry-assurance", "post-ga-regression-management", "api-v5-contract-monitoring", "database-maintenance-certification", "tenant-upgrade-assurance", "performance-regression-control", "dependency-vulnerability-remediation", "accessibility-regression-monitoring", "disaster-recovery-exercises", "administrator-enablement", "customer-adoption-assurance", "defect-burn-down", "production-readiness-reviews", "maintenance-release-orchestration", "version-5.0.1-maintenance-release"];
