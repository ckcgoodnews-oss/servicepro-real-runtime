...
const DOMAINS = ["autonomous-service-desk", "intelligent-ticket-classification", "ai-resolution-recommendations", "automated-dispatch-optimization", "predictive-sla-risk", "technician-copilot", "customer-intent-detection", "workflow-self-healing", "knowledge-gap-detection", "service-quality-scoring", "automated-root-cause-analysis", "ai-change-risk-prediction", "incident-pattern-intelligence", "service-automation-governance", "version-3-1-general-availability"];
