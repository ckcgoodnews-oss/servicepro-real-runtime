...
const DOMAINS = ["version-5-rc-telemetry", "version-5-regression-triage", "api-version-5-compatibility", "database-v5-upgrade-certification", "tenant-v5-migration-dry-runs", "version-5-load-certification", "version-5-dependency-remediation", "version-5-accessibility-certification", "version-5-disaster-recovery-certification", "version-5-administrator-documentation", "version-5-customer-pilot", "version-5-defect-closure", "version-5-production-readiness", "version-5-ga-orchestration", "version-5-general-availability"];
