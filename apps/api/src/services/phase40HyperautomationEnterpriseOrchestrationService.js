...
const DOMAINS = ["enterprise-process-orchestration", "event-driven-automation", "process-mining", "rpa-integration", "business-rule-engine", "workflow-analytics", "intelligent-scheduling", "sla-optimization", "automation-governance", "human-in-the-loop-approvals", "cross-system-transaction-coordination", "automation-observability", "automation-capacity-planning", "orchestration-resilience", "hyperautomation-release-readiness"];
