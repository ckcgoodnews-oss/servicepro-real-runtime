...
const DOMAINS = ["autonomous-ticket-classification", "autonomous-dispatch-recommendations", "self-healing-runbooks", "predictive-incident-prevention", "field-agent-copilot", "parts-demand-optimization", "schedule-rebalancing-agent", "sla-breach-prevention", "customer-communication-agent", "knowledge-gap-detection", "workflow-anomaly-detection", "human-approval-controls", "agent-observability", "agent-cost-governance", "autonomous-operations-release"];
