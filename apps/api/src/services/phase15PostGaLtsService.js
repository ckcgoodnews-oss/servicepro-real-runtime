...
const DOMAINS = ["production-telemetry-baseline", "post-ga-defect-intake", "hotfix-release-management", "customer-impact-incident-coordination", "upgrade-compatibility-scanner", "migration-rollback-verification", "tenant-upgrade-orchestration", "long-term-support-channels", "deprecation-end-of-life-management", "support-entitlement-enforcement", "customer-health-churn-risk", "capacity-cost-optimization", "operational-resilience-exercises", "version-2-0-1-release-readiness", "version-2-0-1-maintenance-release"];
