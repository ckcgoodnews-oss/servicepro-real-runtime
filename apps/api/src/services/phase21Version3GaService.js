...
const DOMAINS = ["rc-production-telemetry", "version3-regression-triage", "api-v3-compatibility-verification", "database-upgrade-rollback-certification", "tenant-migration-dry-runs", "performance-load-certification", "security-hardening-dependency-remediation", "accessibility-browser-compatibility", "disaster-recovery-restore-certification", "upgrade-documentation-admin-guides", "customer-pilot-acceptance-tracking", "release-candidate-defect-closure", "production-deployment-readiness", "version3-ga-release-orchestration", "version3-general-availability"];
