...
const DOMAINS = ["agent-registry", "agent-skills-catalog", "agent-identity-and-access", "agent-task-planning", "human-approval-gates", "multi-agent-coordination", "agent-memory-governance", "agent-tool-permissions", "agent-simulation-sandbox", "agent-quality-evaluation", "agent-cost-controls", "agent-incident-response", "agent-audit-trails", "agent-workforce-analytics", "enterprise-agent-operations"];
