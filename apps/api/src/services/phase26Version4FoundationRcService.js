...
const DOMAINS = ["architecture-decomposition", "domain-event-backbone", "api-version-4-foundation", "data-model-modernization", "frontend-platform-modernization", "identity-architecture-version-4", "policy-engine-version-4", "workflow-runtime-version-4", "observability-architecture-version-4", "performance-baseline-version-4", "compatibility-bridge-version-3-to-4", "version-4-migration-assistant", "version-4-security-baseline", "version-4-release-readiness", "version-4-release-candidate"];
