...
const DOMAINS = ["architecture-modernization", "runtime-upgrade", "frontend-platform-refresh", "api-version-5-foundation", "event-platform-modernization", "data-platform-modernization", "identity-platform-refresh", "tenant-isolation-v5", "performance-engineering-v5", "observability-v5", "security-hardening-v5", "upgrade-tooling-v5", "version-5-pilot", "version-5-production-readiness", "version-5-release-candidate"];
