...
const DOMAINS = ["admin-ai-copilot", "technician-ai-copilot", "autonomous-workflow-recommendations", "semantic-enterprise-search", "enterprise-knowledge-graph", "reasoning-orchestration", "agent-tool-registry", "human-in-the-loop-controls", "natural-language-reporting", "ai-memory-management", "model-routing-optimization", "ai-quality-evaluation", "ai-safety-guardrails", "enterprise-intelligence-observability", "enterprise-intelligence-release"];
