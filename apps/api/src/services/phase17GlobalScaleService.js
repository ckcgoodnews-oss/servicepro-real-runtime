...
const DOMAINS = ["internationalization-foundation", "localization-management", "regional-data-residency", "global-identity-federation", "multi-region-tenant-routing", "cross-region-failover", "edge-synchronization", "regional-configuration-management", "global-notification-localization", "timezone-calendar-localization", "currency-tax-localization", "regional-compliance-packs", "sovereign-cloud-readiness", "global-scale-validation", "global-scale-release"];
