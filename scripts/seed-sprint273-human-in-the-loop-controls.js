...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'human-in-the-loop-controls',name:'Human In The Loop Controls',owner:'platform'});
