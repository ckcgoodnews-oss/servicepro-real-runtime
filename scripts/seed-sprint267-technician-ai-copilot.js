...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'technician-ai-copilot',name:'Technician Ai Copilot',owner:'platform'});
