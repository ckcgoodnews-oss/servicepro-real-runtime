...
async function main() {
  ...
  const row=await repositories.phase17GlobalScale.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'sovereign-cloud-readiness',name:'Sovereign Cloud Readiness',owner:'platform'});
