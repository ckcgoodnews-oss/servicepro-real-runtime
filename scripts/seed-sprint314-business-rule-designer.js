...
async function main() {
  ...
  const row=await repositories.phase19PlatformExtensibility.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'business-rule-designer',name:'Business Rule Designer',owner:'platform'});
