...
async function main() {
  ...
  const row=await repositories.phase17GlobalScale.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'global-scale-release',name:'Global Scale Release',owner:'platform'});
