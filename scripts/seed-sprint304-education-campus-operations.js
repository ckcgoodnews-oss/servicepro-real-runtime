...
async function main() {
  ...
  const row=await repositories.phase18IndustrySolutions.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'education-campus-operations',name:'Education Campus Operations',owner:'platform'});
