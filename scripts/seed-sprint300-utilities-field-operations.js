...
async function main() {
  ...
  const row=await repositories.phase18IndustrySolutions.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'utilities-field-operations',name:'Utilities Field Operations',owner:'platform'});
