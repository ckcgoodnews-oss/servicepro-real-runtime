...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'enterprise-knowledge-graph',name:'Enterprise Knowledge Graph',owner:'platform'});
