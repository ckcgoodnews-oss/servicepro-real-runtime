...
async function main() {
  ...
  const row=await repositories.phase15PostGaLts.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'long-term-support-channels',name:'Long Term Support Channels',owner:'platform'});
