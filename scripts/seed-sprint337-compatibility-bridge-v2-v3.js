...
async function main() {
  ...
  const row=await repositories.phase20Version3Foundation.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'compatibility-bridge-v2-v3',name:'Compatibility Bridge V2 V3',owner:'platform'});
