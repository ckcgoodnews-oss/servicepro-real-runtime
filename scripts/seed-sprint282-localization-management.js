...
async function main() {
  ...
  const row=await repositories.phase17GlobalScale.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'localization-management',name:'Localization Management',owner:'platform'});
