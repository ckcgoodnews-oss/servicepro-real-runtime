...
async function main() {
  ...
  const row=await repositories.phase20Version3Foundation.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'performance-engineering-v3',name:'Performance Engineering V3',owner:'platform'});
