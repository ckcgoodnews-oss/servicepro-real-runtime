...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'semantic-enterprise-search',name:'Semantic Enterprise Search',owner:'platform'});
