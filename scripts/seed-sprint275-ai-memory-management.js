...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'ai-memory-management',name:'Ai Memory Management',owner:'platform'});
