...
async function main() {
  ...
  const row=await repositories.phase19PlatformExtensibility.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'event-schema-registry',name:'Event Schema Registry',owner:'platform'});
