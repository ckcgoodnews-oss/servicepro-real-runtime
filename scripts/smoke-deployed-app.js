...
if (require.main === module) {
  runDeployedSmoke({webUrl:process.env.SMOKE_WEB_URL,apiUrl:process.env.SMOKE_API_URL,tenantId:process.env.SMOKE_TENANT_ID,email:process.env.SMOKE_EMAIL,password:process.env.SMOKE_PASSWORD,expectedVersion:process.env.SMOKE_EXPECTED_VERSION,requireAuth:process.env.SMOKE_REQUIRE_AUTH === 'true',timeoutMs:process.env.SMOKE_TIMEOUT_MS})
