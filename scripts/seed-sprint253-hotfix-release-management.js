...
async function main() {
  ...
  const row=await repositories.phase15PostGaLts.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'hotfix-release-management',name:'Hotfix Release Management',owner:'platform'});
