...
async function main() {
  ...
  const row=await repositories.phase20Version3Foundation.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'runtime-framework-upgrade',name:'Runtime Framework Upgrade',owner:'platform'});
