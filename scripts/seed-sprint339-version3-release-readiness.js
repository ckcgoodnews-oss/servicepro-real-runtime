...
async function main() {
  ...
  const row=await repositories.phase20Version3Foundation.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'version3-release-readiness',name:'Version3 Release Readiness',owner:'platform'});
