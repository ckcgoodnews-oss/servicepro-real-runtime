...
async function main() {
  ...
  const row=await repositories.phase15PostGaLts.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'customer-health-churn-risk',name:'Customer Health Churn Risk',owner:'platform'});
