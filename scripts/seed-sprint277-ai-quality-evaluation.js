...
async function main() {
  ...
  const row=await repositories.phase16EnterpriseIntelligence.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'ai-quality-evaluation',name:'Ai Quality Evaluation',owner:'platform'});
