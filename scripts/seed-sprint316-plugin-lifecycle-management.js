...
async function main() {
  ...
  const row=await repositories.phase19PlatformExtensibility.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'plugin-lifecycle-management',name:'Plugin Lifecycle Management',owner:'platform'});
