...
async function main() {
  ...
  const row=await repositories.phase19PlatformExtensibility.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'visual-workflow-designer',name:'Visual Workflow Designer',owner:'platform'});
