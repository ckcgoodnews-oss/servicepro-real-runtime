...
async function main() {
  ...
  const row=await repositories.phase17GlobalScale.create({tenantId:process.env.DEFAULT_TENANT_ID||'tenant_demo',domain:'multi-region-tenant-routing',name:'Multi Region Tenant Routing',owner:'platform'});
